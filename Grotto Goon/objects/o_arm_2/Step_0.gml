...
if(o_player.current_state != state.Dodging)
{
    ...
    x = o_player.WieldingObject.x + xoffset - (o_player.WieldingObject.sprite_width /2);
    y = o_player.WieldingObject.y + yoffset + (o_player.sprite_height/2) - o_player.WieldingObject.z - (o_player.WieldingObject.sprite_height /2);
