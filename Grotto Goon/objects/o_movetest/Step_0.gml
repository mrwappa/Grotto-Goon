...
{										
	...
	if(o_player.x < x + 36 + o_player.sprite_width/2 and 
	o_player.x > x - 36 - o_player.sprite_width/2)
	{
		if(o_player.y > y + 20)
		{
			bottomline = true;
...
if(distance_to_object(o_player) < 20)
{
	if(o_player.y < y + (sprite_height/2)-1 + o_player.sprite_height/2 and
	 o_player.y > y - (sprite_height/2)+1 - o_player.sprite_height/2)
	{
